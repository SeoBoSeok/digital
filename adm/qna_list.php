...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" width="50">소 속</th>
        <th scope="col" width="50">직 책</th>
        <th scope="col" width="50">날 짜</th>
        <th scope="col" width="50">시 간</th>
        <th scope="col" width="50">문의시간</th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td><?php echo $row["ride_types"]?></td>
        <td><?php echo $row["rsv_group"]?></td>
        <td><?php echo $row["rsv_position"]?></td>
        <td><?php echo $row["rsv_date"]?></td>
        <td><?php echo $row["rsv_time"]?></td>
        <td><?php echo date('Y-m-d H:i:s', strtotime('+9 hours', strtotime($row["create_time"])))?></td>
    </tr>
    <?php
    }
    if ($i == 0)
