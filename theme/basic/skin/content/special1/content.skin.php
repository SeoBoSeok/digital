      ...
      <section class="sec2 ani active">
        <div class="inner">
          ...
          <div class="lists clearfix">
            <div class="left">
              <img src="/common/img/special2.png" alt="정지산 유적">
            </div>
            <div class="right">
              <h3>
              ...
              <dl>
                <dt>소개</dt>
                <dd>
                문화재청이 축적 및 개방하고 있는 디지털문화유산 원천기록 데이터를 국민과 민간기업의 디지털 콘텐츠 소재로 널리 활용되도록 홍보하고 그 저변을 확대하기 위해 문화재청·국립공주대학교 주최, 프로젝트이안 주관으로 <제1회 디지털문화유산 콘텐츠 경진대회>를 개최하였습니다. 대회에서 수상한 31개 작품을 소개합니다.
                </dd>
              </dl>
              <dl>
                <dt>기획</dt>
