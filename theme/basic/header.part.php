      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li><a href="/bbs/content.php?co_id=list">참가업체리스트</a></li>
          </ul>
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            <li><a href="/bbs/content.php?co_id=Invitation_baekjae">디지털로 만나는<br>백제역사유적지구</a></li>
            <li><a href="/bbs/content.php?co_id=Invitation_baekjae_a">소실된 웅진백제기공주<br>정지산유적고건축AR콘텐츠</a></li>
            <li><a href="/bbs/content.php?co_id=Invitation_baekjae_v">정조대왕의 수원화성<br>야간군사 훈련 VAR 콘텐츠</a></li>
            <li><a href="/bbs/content.php?co_id=Invitation_baekjae_m">청동거울,<br>과학을 비추다</a></li>
          </ul>
        </li>
        <li>
